# MVAumap8km1
A fixed radius cover and the associated simplicial complex constructed
from the interections of the fixed radius balls.
...
plt.show()
```
![MVAumap8km1](MVAumap8km1-1_python.png)
![MVAumap8km1](MVAumap8km1-2_python.png)