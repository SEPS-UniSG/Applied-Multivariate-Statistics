# MVAumapsimplcomplex
Examples and a non-example of simplicial complexes.
...
plt.show()
```
![MVAumapsimplcomplex](MVAumapsimplcomplex-1_python.png)
![MVAumapsimplcomplex](MVAumapsimplcomplex-2_python.png)