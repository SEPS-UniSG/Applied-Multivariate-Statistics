# MVAhisbank2
Computes 4 histograms for the diagonal of the forged Swiss bank notes. The histograms are different with respect to their origin.
...
plt.show()
```
![MVAhisbank2](MVAhisbank2-1_python.png)