# MVAclusfood
Performs cluster analysis for the french food data after standardization of the variables.
...
plt.show()
```
![MVAclusfood](MVAclusfood-1_python.png)
![MVAclusfood](MVAclusfood-2_python.png)
![MVAclusfood](MVAclusfood-3_python.png)