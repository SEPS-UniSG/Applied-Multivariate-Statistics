# MVAMDScity2
Computes the map of the cities by application of multidimensional scaling. Reflects and rotates the figure by 90 degrees.
...
plt.show()
```
![MVAMDScity2](MVAMDScity2_python.png)