# SMSclus8pc
Employs the centroid linkage using squared Euclidean distance matrices to perform a cluster analysis on an 8 points example.
...
```
![SMSclus8pc](SMSclus8pc_python.png)