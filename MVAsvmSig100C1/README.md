# MVAsvmSig100C1
Plots an SVM classification plot of bankruptcy data set with sigma = 100 (gamma = 1) and C = 1
```python
...
svc_model = SVC(C=1, kernel='rbf', gamma=1, probability=True)   # Note that the gamma parameter in sklearn doesn't exactly match the sigma parameter in the R kernlab package.
...
```
![MVAsvmSig100C1](MVAsvmSig100C1_python.png)