# MVAportfol_IBM_Ford
Computes the optimal portfolio weights with monthly returns of IBM and Forward Industries from Jan 2000 to Dec 2009. The optimal portfolio is compared with an equally weighted one.
...
```
![MVAportfol_IBM_Ford](MVAportfol_IBM_Ford_python.png)