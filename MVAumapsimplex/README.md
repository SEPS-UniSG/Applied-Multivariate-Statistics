# MVAumapsimplex
Some simplices: the 0-simplex (point or vertex), the 1-simplex (line
segment or edge), the 2-simplex (triangle), and the 3-simplex, the tetrahedron.
...
plt.show()
```
![MVAumapsimplex](MVAumapsimplex-1_python.png)
![MVAumapsimplex](MVAumapsimplex-2_python.png)
![MVAumapsimplex](MVAumapsimplex-3_python.png)
![MVAumapsimplex](MVAumapsimplex-4_python.png)